...
class Carte:
    ...
    SCREEN_WIDTH = 600
    SCREEN_HEIGHT = 600
    GRID_SIZE = 5  # Nombre de cellule de la grille sur une ligne ou sur une colonne.
    ...
    def dessiner_grille(cls):
        ...
        # Dessiner l'image d'arrière-plan sur l'écran(screen)
        cls.screen.blit(cls.background_image, (0, 0))
