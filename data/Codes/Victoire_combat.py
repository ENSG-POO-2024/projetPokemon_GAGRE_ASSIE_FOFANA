...
class Ui_Victoire_combat(object):
    def setupUi(self, Victoire_combat):
        ...
        self.Arriere.setPixmap(QtGui.QPixmap("../Images/Victoire.jpg"))
    ...
    def retranslateUi(self, Victoire_combat):
        ...
        Victoire_combat.setWindowTitle(_translate("Victoire_combat", "  POKEMON"))
        Victoire_combat.setWindowIcon(QtGui.QIcon("../Images/Pokemon_logo.png"))
