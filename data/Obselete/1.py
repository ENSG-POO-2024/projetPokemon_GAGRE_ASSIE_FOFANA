...
class Carte(QMainWindow):
    ...
    def __init__(self):
        ...
        # Création du joueur
        rows = 2 * (random.randint(0, Carte.GRID_SIZE))
        cols = (random.randint(0, Carte.GRID_SIZE)) / 2
    ...
    def keyPressEvent(self, event):
        ...
        print("Ligne 114 : ", self.joueur.row, self.joueur.col)
        self.lespokemons.show_nearest((self.joueur.row, self.joueur.col))
        self.repaint()  # Redessine la fenêtre après le déplacement du joueur
