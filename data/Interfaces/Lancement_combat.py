...
class Ui_Lancement_combat(object):
    def setupUi(self, Lancement_combat):
        ...
        self.Nom_Pokemon_3.setGeometry(QtCore.QRect(360, 170, 151, 41))
        font = QtGui.QFont()
        ...
        self.Nom_Pokemon_2.setGeometry(QtCore.QRect(180, 170, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Rockwell Extra Bold")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.Adversaire.setPixmap(QtGui.QPixmap("../Pokemon_images/Abra.png"))
    ...
    def retranslateUi(self, Lancement_combat):
        ...
        Lancement_combat.setWindowTitle(_translate("Lancement_combat", " "))
