...
class Ui_Bienvenue(object):
    def setupUi(self, Bienvenue):
        ...
        self.setFixedSize(1100, 633)
        self.background = QtWidgets.QLabel(Bienvenue)
        self.background.setGeometry(QtCore.QRect(10, 10, 1080, 608))
        self.background.setStyleSheet("background-color: rgb(27, 170, 84);border-radius:40px;")
        self.background.setPixmap(QtGui.QPixmap("../Images/background/bienvenue_2.png"))
        self.background.setObjectName("background")
        self.bg_transparant = QtWidgets.QLabel(Bienvenue)
        self.bg_transparant.setGeometry(QtCore.QRect(10, 10, 1080, 611))
        self.bg_transparant.setStyleSheet("background-color: rgba(0, 0, 0,180);")
        self.bg_transparant.setObjectName("bg_transparant")
        ...
        self.player_age.setStyleSheet(
            "background-color: rgba(0, 0, 0, 0);border-bottom: 2px solid rgba(200, 200, 200, 180);color: rgba(255, 255, 255,180);border-top: 0;border-left: 0;border-right: 0;padding-bottom: 7px;")
        ...
        self.gender_choice.setStyleSheet(
            "background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(100, 100, 100, 255));border: 1px solid #FFFFFF;border-radius: 5px;padding: 1px 18px 1px 3px;min-width: 6em;font-size: 12px;font: 13pt 'MS Shell Dlg 2';color: rgba(255, 255, 255,200);")
        ...
        self.cancel.setGeometry(QtCore.QRect(310, 540, 201, 41))
        self.cancel.setStyleSheet(
            "background-color: #CC0000;border: 1px solid #FFFFFF;border-radius: 5px; color: white;font: bold 14pt \'Arial\';box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.4);")
        self.cancel.setObjectName("play")
        self.cancel.clicked.connect(Bienvenue.close)
        self.play = QtWidgets.QPushButton(Bienvenue)
        self.play.setGeometry(QtCore.QRect(600, 540, 201, 41))
        self.play.setStyleSheet(
            "background-color: #00CC00;border: 1px solid #FFFFFF;border-radius: 5px; color: white;\nfont: bold 14pt \'Arial\';box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.4);")
    ...
    def retranslateUi(self, Bienvenue):
       ...
       Bienvenue.setWindowTitle(_translate("Bienvenue", "Dialog"))
