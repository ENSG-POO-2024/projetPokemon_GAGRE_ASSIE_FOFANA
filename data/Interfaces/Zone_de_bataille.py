...
class Ui_Zone_de_bataille(object):
    def setupUi(self, Zone_de_bataille):
        ...
        self.PV_adversaire.setGeometry(QtCore.QRect(712, 255, 171, 31))
        font = QtGui.QFont()
        ...
        self.PV_adversaire.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.PV_adversaire.setObjectName("PV_adversaire")
        self.PV_attaquant = QtWidgets.QLabel(self.Ensemble_bataille)
        self.PV_attaquant.setGeometry(QtCore.QRect(292, 255, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Rockwell Extra Bold")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.PV_attaquant.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
